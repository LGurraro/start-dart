//TODO:O sistema deve continuar exibindo o menu e as informações normalmente, porém ele deve rodar 18 vezes e não apenas uma, como é hoje em dia.

import 'dart:io';

void main() {
  for (var contador = 1; contador <= 18; contador++) {
