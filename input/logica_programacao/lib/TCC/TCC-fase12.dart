// TODO: Transforme a exibição do menu principal em uma função sem retorno e sem parâmetros.
          ...
          if (opcaoPromo == 8) {
            if (carrinho.length >= 3) {
              ...
              if (codigoProduto == 101) {
                carrinho
                    .add({'nome': 'Ração Royal Canin Indoor', 'preco': 290.00});
                print(
                    'Produto adicionado: Ração Royal Canin Indoor - R\$290,00');
              } else if (codigoProduto == 102) {
                carrinho.add(
                    {'nome': 'Ração Royal Canin Sterilised', 'preco': 492.00});
                print(
