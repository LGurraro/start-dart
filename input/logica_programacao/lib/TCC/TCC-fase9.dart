//TODO: Você deve alterar o sistema para que ele funcione para N clientes e não mais apenas 18 vezes.
// Ao final da consulta de um cliente, o sistema deve apresentar os itens de menu acrescido da opção 0 – Sair.
// Ao digitar a opção 0, o sistema deve sair do programa e exibir quantos clientes usaram o sistema naquele dia.

import 'dart:io';

void main() {
  var opcaoMenu = -1;
  var quantidadeClientes = 0; // Contador de clientes
...
""");
      ...
      opcaoMenu = int.parse(itemDoMenuLeitura);
      ...
      switch (opcaoMenu) {
        ...
        case 4:
          print(
              'Novos serviços oferecidos: Hidratação de pelo R\$ ${precoHidratacao.toStringAsFixed(2)} Tosa higienica por R\$ ${precoTosaHigienica.toStringAsFixed(2)} | Tingimento dos pelo por R\$ ${precoTingimento.toStringAsFixed(2)}');
          break;
        case 5:
        ...
        case 0:
          ...
          print('Total de clientes atendidos: $quantidadeClientes');
          break;
        default:
      ...
      quantidadeClientes++; // Incrementa o contador de clientes
    }
  }
}
